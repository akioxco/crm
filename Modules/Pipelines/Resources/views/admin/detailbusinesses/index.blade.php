...
@section('content-header')
    <h1>
        {{ trans('pipelines::detailbusinesses.title.detailbusinesses') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li class="active">{{ trans('pipelines::detailbusinesses.title.detailbusinesses') }}</li>
    </ol>
@stop
        ...
        <div class="col-xs-12">
            <div class="row">
                <div class="btn-group pull-right" style="margin: 0 15px 15px 0;">
                    <a href="{{ route('admin.pipelines.detailbusiness.create') }}" class="btn btn-primary btn-flat" style="padding: 4px 10px;">
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="data-table table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if (isset($detailbusinesses)): ?>
                            <?php foreach ($detailbusinesses as $detailbusiness): ?>
                            <tr>
                                <td>
...
@section('shortcuts')
    <dl class="dl-horizontal">
        <dt><code>c</code></dt>
        <dd>{{ trans('pipelines::detailbusinesses.title.create detailbusiness') }}</dd>
    </dl>
@stop
    ...
    <script type="text/javascript">
        $( document ).ready(function() {
            $(document).keypressAction({
                actions: [
                    { key: 'c', route: "<?= route('admin.pipelines.detailbusiness.create') ?>" }
                ]
            });
        });
    </script>
